...
- Вторая функция:
  ...
  2. В самой функции:
    ...
    - Вызываем первую функцию чтобы получить необходимые данные с файла в виде списка.

    - Объявляем вспомогательные переменные в которые будем записывать всю нужную информацию.

    - Пробираем по списку и ищем название товара, которое надо найти и запоминаем необходимые данные.
